...
public class Owner  implements java.io.Serializable {
    ...
    public Owner(int ownerId, Serializable email, Serializable phone, boolean isActive, Serializable createBy, Date createTime, Serializable updateBy, Date updateTime) {
    ...
    public Owner(int ownerId, Serializable email, Serializable firstName, Serializable lastName, Integer sex, Serializable phone, Serializable address, boolean isActive, Serializable createBy, Date createTime, Serializable updateBy, Date updateTime, Set<Goods> goodses, Set<Account> accounts) {
       this.ownerId = ownerId;
       this.email = email;
