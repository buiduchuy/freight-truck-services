...
public class Employee  implements java.io.Serializable {
    ...
    public Employee(int employeeId, Serializable email, Serializable phone, int sex, Serializable image) {
    ...
    public Employee(int employeeId, Serializable email, Serializable firstName, Serializable lastName, Serializable phone, int sex, Serializable image, Set<Account> accounts) {
       this.employeeId = employeeId;
       this.email = email;
