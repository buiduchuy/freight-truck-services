	...
	protected void processRequest(HttpServletRequest request,
		...
		try (PrintWriter out = response.getWriter()) {
			...
			if (action.equalsIgnoreCase("pay")) {
				...
				double price = Double.parseDouble(request.getParameter("amount")) / 21;
				...
				transaction.setInvoiceNumber("AAAAAAAAAAAA");
				...
				redirectUrls.setReturnUrl("http://localhost:8080/FTS/PaypalServlet?btnAction=success");
				...
				response.sendRedirect(request.getContextPath() + "/ProcessServlet?btnAction=manageOrder");
			}
		}
	}
