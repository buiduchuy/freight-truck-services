...
<a href="ProcessServlet?btnAction=manageDeal"
	class="button menu-button expand left" style="text-align:left;padding-left:10px;background-color: #F99D1C;color: white;"><i class="icon-exchange"></i> Quản lý đề nghị</a>
