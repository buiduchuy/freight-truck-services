...
<footer>
	<section class="footer-copyright">
		<div class="row">
			<div class="small-6 large-6 columns">Bản quyền © 2015</div>
			<div class="small-6 large-6 columns">
				<nav id="footer-nav" class="text-right">
					<ul id="bot-nav" class="inline-list">
						<li><a href="ProcessServlet" target="_blank">Trang chủ</a></li>
...
<script type="text/javascript" src="js/civem-0.0.7.min.js"
	charset="UTF-8"></script>
</html>
