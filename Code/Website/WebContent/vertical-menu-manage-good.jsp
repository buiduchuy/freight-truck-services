...
<a href="ProcessServlet?btnAction=manageGoods"
	class="button menu-button expand left active" style="text-align:left;padding-left:10px;background-color: #F99D1C;color: white;"><i class="icon-list"></i> Quản lý hàng</a>
