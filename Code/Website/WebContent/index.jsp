                ...
                <div class="navbar-collapse collapse">
                    ...
                    <c:choose>
                        <c:when test="${not empty account}">
                            ...
                            <c:otherwise>
                            <ul id="nav" class="nav navbar-nav navbar-right">
                                <li class="menu-dang-nhap"><a title="Đăng nhập" href="ProcessServlet?btnAction=loginPage"><font color="gray" size="+1">ĐĂNG NHẬP</font></a></li>
                                <li class="menu-dang-ky-dich-vu"><a href="ProcessServlet?btnAction=registerPage"><font color="gray" size="+1">ĐĂNG KÝ</font></a></li>
                            </ul> 
                        </c:otherwise>
                    </c:choose>
