									...
									<div class="large-12 columns">
										<div class="row">
											<div class="small-4 columns">
												<label for="right-label" class="right inline">Chi
													phí hệ thống đề nghị: </label>
											</div>
												...
												<c:choose>
													<c:when test="${not empty priceSuggest}">
														<input type="text" id="right-label"
															value="${ priceSuggest}" name="txtPriceSystem"
															readonly="" />
													</c:when>
													<c:otherwise>
														<input type="text" id="right-label"
											...
											<div class="small-2 columns">
												<label for="right-label" class="left inline">nghìn
													đồng</label>
											</div>
										</div>
										<div class="row">
										...
										<div class="row">
											<div class="large-12 columns">
												</br> <label> <font style="color: orange">Nếu bạn
														để trống ô "Chi phí người dùng" thì hệ thống sẽ lấy chi
														phí đề nghị làm chi phí hàng hoá. </font>
												</label>
												<div class="submit-area right">

													<a href="GoodsServlet?btnAction=viewCreate_2"
							...
							<c:otherwise>
								<div class="row">
									<div class="large-12 columns">
										...
										<div class="row">
											<div class="large-12 columns">
												<label> <font style="color: orange">Nếu bạn
														để trống ô "Chi phí người dùng" thì hệ thống sẽ lấy chi
														phí đề nghị làm chi phí hàng hoá. </font>
												</label>
												<div class="submit-area right">
