                            ...
                            <div class="large-12 columns">
                                ...
                                <div class="row">
                                    <div class="small-8 columns">
                                        ...
                                        <div class="small-9 columns">
                                            <input class="left inline" type="text"onFocus="geolocate()" id="place_start" pattern=".{1,100}" placeholder="Nhập địa điểm giao hàng" required=""data-errormessage-value-missing="Vui lòng chọn địa điểm giao hàng !" data-errormessage-pattern-mismatch="Bạn phải nhập địa chỉ [1-50] kí tự !"/>
                                        </div>
                                    </div>
                                     <div class="small-4 columns">
                                ...
                                <div class="row">
                                    <div class="small-8 columns">
                                        ...
                                        <div class="small-8 columns">
                                            <input type="text" onFocus="geolocate()" id="place_end" pattern=".{1,100}" placeholder="Nhập địa điểm nhận hàng" required=""data-errormessage-value-missing="Vui lòng chọn địa điểm nhận hàng !" data-errormessage-pattern-mismatch="Bạn phải nhập địa chỉ [1-50] kí tự !"/>
                                        </div>
                                    </div>
                                    <div class="small-4 columns">
                                        <div class="small-5 columns">
