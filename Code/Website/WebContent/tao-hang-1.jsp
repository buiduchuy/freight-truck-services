                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                <div class="small-8 columns">
                                    ...
                                    <div class="small-9 columns">
                                        <input class="left inline" name="txtpickupAddress"type="text"onFocus="geolocate()" id="place_start" pattern=".{1,100}" placeholder="Nhập địa điểm giao hàng" required=""data-errormessage-value-missing="Vui lòng chọn địa điểm giao hàng !" data-errormessage-pattern-mismatch="Bạn phải nhập địa chỉ [1-100] kí tự !"/>
                                    </div>
                                </div>
                                <div class="small-4 columns">
                                    ...
                                    <div class="small-7 columns">
                                        <input type="text" name="txtpickupTime"value="<fmt:formatDate type="date" value='${today}' pattern='dd-MM-yyyy'/> " id="pick-up-date" data-date-format="dd-mm-yyyy" readonly >                          
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="small-8 columns">
                                    ...
                                    <div class="small-9 columns">
                                        <input type="text" onFocus="geolocate()" name="txtdeliveryAddress"id="place_end" pattern=".{1,100}" placeholder="Nhập địa điểm nhận hàng" required=""data-errormessage-value-missing="Vui lòng chọn địa điểm nhận hàng !" data-errormessage-pattern-mismatch="Bạn phải nhập địa chỉ [1-100] kí tự !"/>
                                    </div>
                                </div>
                                <div class="small-4 columns">
                                    <div class="small-5 columns">
                                    ...
                                    <div class="small-7 columns">
                                        <input type="text" name="deliveryTime" value="<fmt:formatDate type="date" value='${tomorrow}' pattern='dd-MM-yyyy'/>" id="dilivery-date" data-date-format="dd-mm-yyyy" readonly>                           
                                    </div>
                                </div>
                            </div>
                            <div class="row">
