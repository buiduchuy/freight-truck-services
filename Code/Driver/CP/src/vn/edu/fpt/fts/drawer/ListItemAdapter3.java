...
public class ListItemAdapter3 extends BaseAdapter{

	private Context context;
	private ArrayList<ListItem> listItems;
	
	public ListItemAdapter3(Context context, ArrayList<ListItem> listItems){
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.listview_item_row_3, null);
        }
